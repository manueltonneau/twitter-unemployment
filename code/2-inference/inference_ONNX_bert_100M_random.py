...
parser.add_argument("--model_path", type=str, help="path where the models are stored")
...
for column in ["is_unemployed", "lost_job_1mo", "job_search", "is_hired_1mo", "job_offer"]:
    ...
    model_path = os.path.join(args.model_path, args.country_code, best_model_folder,
