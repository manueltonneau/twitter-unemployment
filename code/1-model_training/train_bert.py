...
<EVAL_DATA_PATH>: Path to the evaluation data CSV
...
<TIMESTAMP>: The timestamp from the Slurm job

<JOB_ID>: The Slurm job ID

<INTRA_EPOCH_EVAL>: Whether to perform intra-epoch evaluation. Boolean.


Example usage:
python train_bert.py \
--train_data_path ./train_is_hired_1mo.csv \
--eval_data_path ./val_is_hired_1mo.csv \
--model_name bert \
--model_type bert-base-cased \
--num_train_epochs 10 \
--output_dir /home/toto/my_output_folder \
"""
import os
import shutil, errno
import logging
