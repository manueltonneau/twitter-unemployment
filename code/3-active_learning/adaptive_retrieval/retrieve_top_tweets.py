...
if __name__ == '__main__':
    ...
    random_path = f'{args.data_path}/random_samples/random_samples_splitted'
    ...
    for iteration_number in range(int(args.iteration_number)):
        ...
        path_to_labelled = f'{args.data_path}/train_test/{args.country_code}/{data_folder_name}/raw'
    ...
    for label in ['is_hired_1mo', 'lost_job_1mo', 'job_search', 'is_unemployed', 'job_offer']:
        inference_path = os.path.join(args.data_path, 'inference')
    ...
    output_path = f'{args.data_path}/active_learning/adaptive_retrieval/{args.country_code}/{args.inference_folder}'
