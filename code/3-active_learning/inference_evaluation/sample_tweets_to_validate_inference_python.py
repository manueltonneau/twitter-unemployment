...
if __name__ == '__main__':
    ...
    path_to_tweets = os.path.join(
        f'{args.data_path}/random_samples/random_samples_splitted',
        args.country_code,
    ...
    path_to_evals = os.path.join(
        f'{args.data_path}/active_learning/evaluation_inference',
    ...
    for label in ['is_hired_1mo', 'lost_job_1mo', 'is_unemployed', 'job_search', 'job_offer']:
        path_to_scores = os.path.join(f'{args.data_path}/inference',
